      ...
      <div style={{ position: "absolute", inset: 0, pointerEvents: "none", overflow: "hidden", zIndex: 2 }}>
        {[...Array(6)].map((_, i) => (
          <div key={i} style={{ position: "absolute", left: "-20%", right: "-20%", top: 0, display: "flex", alignItems: "center", justifyContent: "center", transform: `rotate(-15deg) translateY(${i * 140 - 60}px)` }}>
            <div style={{ fontSize: 11, fontFamily: "ui-monospace,monospace", whiteSpace: "nowrap", userSelect: "none", letterSpacing: 6, fontWeight: 400, color: "rgba(0,0,0,0.12)", textShadow: "0 0 0 rgba(255,255,255,0.12)", mixBlendMode: "difference", WebkitFontSmoothing: "none" }}>
